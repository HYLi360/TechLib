...
> usage: 1_get_gff_len.py [-h] --input INPUT --outgff OUTGFF --outlens OUTLENS --type TYPE [--chrrm CHRRM]
> 
...
> A：这部分推荐交给jcvi，或者TBtools-II，然后使用 -icl 的结果。不过还是那句话——如果想作图，建议先改len文件，把散在的Chr删掉，再跑WGDI，效果会更好。
